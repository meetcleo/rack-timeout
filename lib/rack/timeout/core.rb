...
module Rack
  class Timeout
    ...
    RequestDetails = Struct.new(
      ...
      :term,
      :path, # info on the path of the request
    ) {
    ...
    PATH_INFO = 'PATH_INFO'.freeze # the key where the path is stored
...
MSG
    ...
    def call(env)
      ...
      path      = env[PATH_INFO] # the path of this request (for logging)
